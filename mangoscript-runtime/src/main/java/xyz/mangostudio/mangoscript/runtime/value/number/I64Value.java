...
public record I64Value(long value) implements NumberValue {
	@Override
	public PrimitiveType getType() { return PrimitiveType.I64; }
	...
	public Value add(Value another) {
		...
		if (another instanceof I64Value a) return new I64Value(value + a.value);
	...
	public Value lessThan(Value another) {
		if (another instanceof I64Value a) return new I32Value(value < a.value ? 1 : 0);
		NumberValue[] a = NumberValue.castForMathOperators(this, another);
	...
	@Override
	public Value not() {
		return new I64Value(value == 0 ? 1 : 0);
	}
