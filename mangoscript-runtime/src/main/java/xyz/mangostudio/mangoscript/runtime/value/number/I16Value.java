...
public record I16Value(short value) implements NumberValue {
	@Override
	public PrimitiveType getType() { return PrimitiveType.I16; }
	...
	public Value add(Value another) {
		...
		if (another instanceof I16Value a) return new I16Value((short) (value + a.value));
	...
	public Value lessThan(Value another) {
		if (another instanceof I16Value a) return new I32Value(value < a.value ? 1 : 0);
		NumberValue[] a = NumberValue.castForMathOperators(this, another);
	...
	@Override
	public Value not() {
		return new I16Value(value == 0 ? (short) 1 : (short) 0);
	}

	@Override
	public Value negate() {
		return new I16Value((short) (-value));
	}

	@Override
	public Value inc() {
		return new I16Value((short) (value + 1));
	}
